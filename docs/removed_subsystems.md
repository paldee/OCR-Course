...
เป็นบังคับ** สอดคล้องกับ CHK7 ที่พบภาคเรียนหน่วยกิตเกิน เช่น IT/2560 ปี 3 ภาค 1
รวม 36 หน่วยกิต (12 วิชา) ซึ่งเมื่อไล่ดูพบว่าเป็นวิชาแขนง (เกม, กราฟิก, เครือข่ายไร้สาย)
ที่ถูก tag เป็นบังคับทั้งหมด

กระทบคำถามที่ถามว่า "วิชาบังคับมีอะไรบ้าง" ของ IT/AIT — ยังไม่แก้เพราะต้องแก้
`populate_courses.py` แล้ว re-populate ซึ่งควรทำพร้อมกับตรวจ regression ของ
field accuracy เดิม
