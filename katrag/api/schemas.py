...
class AskRequest(BaseModel):
    ...
    program: str = Field(
        ...
        max_length=10,
        description=(
            "หลักสูตรที่ผู้ใช้เลือก (IT/DSBA/AIT/BIT/AITBA) — บังคับ "
            "เพราะข้อมูลหลักสูตรผูกกับสาขา คำถามที่ไม่ระบุสาขาไม่มีคำตอบเดียวที่ถูก "
            "(เช่น 'วิชาฐานข้อมูลกี่หน่วยกิต' ต่างกันทั้ง 5 หลักสูตร) "
            "ถ้าคำถามระบุชื่อหลักสูตรมาเองจะใช้ค่าในคำถามแทน"
        ),
    )
