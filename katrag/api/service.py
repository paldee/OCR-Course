            ...
            if not hits:
                ...
                try:
                    ...
                    prompt = (
                        ...
                        "ใช้เฉพาะข้อมูลจากหลักฐานด้านล่างในการตอบ ตอบเป็นภาษาไทย\n"
                        "สำคัญ: ถ้าคำถามถามเรื่องวิชา ให้ระบุ **ทุกวิชาที่เกี่ยวข้อง** ที่พบในหลักฐาน "
                        "แม้จะเกี่ยวข้องบางส่วน (เช่น วิชาที่มีคำว่า programming/โปรแกรม ในชื่อ) "
                        "พร้อมรหัสวิชา ชื่อวิชา จำนวนหน่วยกิต และชั้นปี/ภาคที่เรียน (ถ้ามี)\n"
                        "ระบุหมายเลขหลักฐาน [n] ที่ใช้อ้างอิงในคำตอบ\n"
