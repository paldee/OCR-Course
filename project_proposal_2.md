...
| 4 | วิชาที่มีในหลักสูตร DSBA 2560 แต่ไม่มีในหลักสูตร 2565 มีอะไรบ้าง? | ⚠️ **เฉลยยังไม่ชี้ชัด** — เดิมเขียนไว้เป็นตัวอย่างกว้าง ๆ ("เช่น วิชาภาษาอังกฤษเฉพาะทาง") จึงตัดสินถูก/ผิดไม่ได้ ต้องทำเป็นรายการรหัสวิชาที่ set-difference ได้จริง (DSBA 2560 มี 71 วิชา / 2565 มี 75 วิชาในฐาน) ก่อนใช้เป็นเกณฑ์วัด | หน้า 12 (2560) vs หน้า 12 (2565) |
