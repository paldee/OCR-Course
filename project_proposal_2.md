...
AIT 0.950 | DSBA 0.912 | IT 0.911 | BIT 0.855

**หมายเหตุ:** ตัวเลขลดจาก 0.967 (5 ฟิลด์) เพราะเพิ่ม category/type เข้ามาวัด ซึ่งเป็นฟิลด์ใหม่ที่เพิ่งสกัดได้ (จากเดิม 0% ทุกรายการ):
- **category** (หมวดวิชาเฉพาะ/ศึกษาทั่วไป/เลือกเสรี): AIT 85% | BIT 87% | DSBA 95%
- **type** (บังคับ/เลือก): AIT 85% | BIT 35% | DSBA 55%

type ยังต่ำเพราะ carry-forward ข้ามหน้ายังไม่ reset เมื่อเปลี่ยนปี/เทอม (known gap)

**Prerequisite extraction** (ใหม่ — เพิ่งสร้าง):
- IT: 12/16 ถูกต้อง (75%) จากเดิม 0/16
- BIT: 2/3 ถูกต้อง
- รวม: 84 วิชาจาก 1,419 มีข้อมูล prerequisite (จากเดิม 54 แต่ผิดตัว → ตอนนี้ถูกตัว)
